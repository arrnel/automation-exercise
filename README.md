...
| GH_OWNER                     | +          |                       | Имя профиля репозитория в github. Если делали форк репозитория то нужно указать имя аккаунта.                                                                                                                                                        |
| GH_REPO                      | +          |                       | Имя репозитория в github. Если делали форк репозитория то нужно указать имя аккаунта.                                                                                                                                                                |
